    ...
    return (
        <section className="max-w-2xl mx-auto text-center py-24">
            ...
            <div className='bg-white rounded-full p-2 relative group cursor-pointer hover:shadow-lg shadow-cyan-400 hover:scale-105'>
                ...
                <div className='bg-white rounded-full p-2 relative group cursor-pointer hover:shadow-lg shadow-cyan-400 hover:scale-105'>
                    <Image alt="react" src="/reactIcon.png" height={100} width={100} className="flex-none" />
                    <Tooltip text='react' className='hidden group-hover:block' />
                </div>
                <div className='bg-white rounded-full p-2 relative group cursor-pointer hover:shadow-lg shadow-cyan-400 hover:scale-105'>
                    <Image alt="tailwind" src="/tailwind.png" height={100} width={100} className="flex-none" />
                    <Tooltip text='tailwind' className='hidden group-hover:block' />
                </div>
                <div className='bg-white rounded-full p-2 relative group cursor-pointer hover:shadow-lg shadow-cyan-400 hover:scale-105'>
                    <Image alt="mongodb" src="/mongodb.png" height={100} width={100} className="flex-none" />
                    <Tooltip text='mongodb' className='hidden group-hover:block' />
                </div>
                <div className='bg-white rounded-full p-2 relative group cursor-pointer hover:shadow-lg shadow-cyan-400 hover:scale-105'>
                    <Image alt="git" src="/git.png" height={100} width={100} className="flex-none" />
                    <Tooltip text='git' className='hidden group-hover:block' />
                </div>
                <div className='bg-white rounded-full p-2 relative group cursor-pointer hover:shadow-lg shadow-cyan-400 hover:scale-105'>
                    <Image alt="postgresql" src="/postgresql.png" height={100} width={100} className="flex-none p-2" />
                ...
                <div className='bg-white rounded-full p-2 relative group cursor-pointer hover:shadow-lg shadow-cyan-400 hover:scale-105'>
                    <Image alt="javascript" src="/js.png" height={100} width={100} className="flex-none" />
                    <Tooltip text='javascript' className='hidden group-hover:block' />
                </div>
                <div className='bg-white rounded-full p-2 relative group cursor-pointer hover:shadow-lg shadow-cyan-400 hover:scale-105'>
                    <Image alt="java" src="/java.png" height={100} width={100} className="flex-none" />
                    <Tooltip text='java' className='hidden group-hover:block' />
                </div>
                <div className='bg-white rounded-full p-2 relative group cursor-pointer hover:shadow-lg shadow-cyan-400 hover:scale-105'>
                    <Image alt="c" src="/c.png" height={100} width={100} className="flex-none" />
